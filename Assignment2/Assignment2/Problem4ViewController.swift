...
//
//  Description: This view controller deals with the Problem 4 of the Assignment. It contains 2 2D Matrices i.e 'before' and 'after', which represent the state of the cells initially and then in the subsequent frame respectively. This view controller makes use of Engine.swift from where it gets the value of the 'after' matrix.
//
