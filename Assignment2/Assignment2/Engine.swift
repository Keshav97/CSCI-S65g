...
//
//  This file acts as the brain/engine of Problem 3 and Problem 4 in the assignment. It is used to determine the 'after' matrix, so that it can be used by the repective view conttrollers.
//
//
...
// Counts number of alive neighbours for a given cell
func countNeighboursAlive2(cellGrid: [[Bool]], cellNeighbours: [(Int, Int)]) -> Int {
    var numberOfNeigbours = 0
